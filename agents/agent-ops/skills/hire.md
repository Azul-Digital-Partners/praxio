...
4. Invoke `/setup agent {slug}` to run through the 4Cs walkthrough and connection validation. Note: `/setup` will pause at the capability boundary sign-off step (Step 3) — this requires explicit operator confirmation before it continues.
